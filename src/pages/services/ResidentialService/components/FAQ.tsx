...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, we offer a 100% satisfaction guarantee on all our residential duct cleaning services. If you're not completely satisfied, we'll return to address any concerns at no additional cost."
    },
    {
